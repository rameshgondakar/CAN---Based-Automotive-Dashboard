...
void main(void)
{
    ...
    while(1)
    {
         clcd_print("SD TEM GR RP IN", (0x80 + (0)));

        can_receive();
        if(can_payload[2]==0x10)
        {
            clcd_putch(can_payload[5],(0xC0 + (0)));
            clcd_putch(can_payload[6],(0xC0 + (1)));
        }
        can_receive();
        if(can_payload[2]==0x20)
        {
            clcd_putch(can_payload[5],(0xC0 + (3)));
            clcd_putch(can_payload[6],(0xC0 + (4)));
            clcd_putch(can_payload[6],(0xC0 + (5)));
        }
        can_receive();
        if(can_payload[2]==0x30)
        {
            clcd_putch(can_payload[5],(0xC0 + (7)));
        }
        can_receive();
        if(can_payload[2]==0x40)
        {
            clcd_putch(can_payload[5],(0xC0 + (9)));
            clcd_putch(can_payload[6],(0xC0 + (10)));
            clcd_putch(can_payload[7],(0xC0 + (11)));
            clcd_putch(can_payload[8],(0xC0 + (12)));
        }
        can_receive();
        if(can_payload[2]==0x50)
        {
             if(can_payload[5]== 0x0E)
                {
                 clcd_putch('L',(0xC0 + (14)));
                ...
                else if(can_payload[5]==0x0D)
                {
                    clcd_putch('R',(0xC0 + (14)));
                    RB0=0;
                    RB1=0;
                    RB6=1;
                    RB7=1;
                ...
                else if(can_payload[5]==0x0B)
                {
                    clcd_print("OF",(0xC0 + (14)));
                      RB0=0;
                      RB1=0;
                      RB6=0;
                      RB7=0;
